...
@implementation DSKJoystickKeysView

- (id)initWithRadius:(CGFloat)radius {
    if (self = [super initWithRadius:radius]) {
        self.upKey = [IDBKey keyWithScancode:SDL_SCANCODE_UP];
        self.downKey = [IDBKey keyWithScancode:SDL_SCANCODE_DOWN];
        self.rightKey = [IDBKey keyWithScancode:SDL_SCANCODE_RIGHT];
        self.leftKey = [IDBKey keyWithScancode:SDL_SCANCODE_LEFT];
    }
    return self;
}
