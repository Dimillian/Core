...
@property (readwrite, nonatomic) DDControlGridView *controlGridView;
...
- (id)initWithIDBModel:(DDCommand *)dosModel andDOSView:(DDView *)dosView {
    if (self = [super init]) {
        _dosView = dosView;
        _dosModel = dosModel;
        _menuVisible = NO;
...
- (void)loadView {
    ...
    self.controlGridView = [[DDControlGridView alloc] initWithFrame:self.view.bounds];
